...
project = 'Proxmox Datacenter Manager'
copyright = '2023 - 2026, Proxmox Server Solutions GmbH'
...
html_theme_options = {
    ...
    'extra_nav_links': {
        ...
        'PDF': 'proxmox-datacenter-manager.pdf',
...
htmlhelp_basename = 'ProxmoxDatacenterManagerdoc'
...
latex_documents = [
    (master_doc, 'ProxmoxDatacenterManager.tex', 'Proxmox Datacenter Manager Documentation',
